...
const handleDeleteOrig = `  const handleDelete = async (id: string, name: string) => {
...
const handleSubmitOrig = `  const handleEmployeeSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    
    // Construct 26 columns row`;

const handleSubmitNew = `  const handleEmployeeSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
