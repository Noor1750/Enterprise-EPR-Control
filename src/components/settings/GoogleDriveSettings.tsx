        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="border border-emerald-100 bg-emerald-50/40 rounded-xl p-5 flex flex-col justify-between space-y-4">
            ...
            <button
              ...
              className="w-full py-2 px-3 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold rounded-lg flex items-center justify-center gap-2 transition-colors shadow-sm disabled:opacity-50"
            >
          ...
          <div className="border border-blue-100 bg-blue-50/40 rounded-xl p-5 flex flex-col justify-between space-y-4">
            <div className="space-y-2.5">
              ...
              <div>
                <input
                  ...
                  className="w-full px-3 py-2 border border-blue-200 rounded-lg text-xs focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white"
                />
              </div>
            </div>
            ...
            <button
              ...
              className="w-full py-2 px-3 bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold rounded-lg flex items-center justify-center gap-2 transition-colors shadow-sm"
            >
